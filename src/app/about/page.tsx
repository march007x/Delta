  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-12">
      ...
      <p className="text-[16px] leading-[1.8] text-ink-2">
        ...
        ทุกบทเรียนจึงเดินตามลำดับ 13 ขั้นเหมือนกันหมด และลำดับนี้ไม่ได้ตั้งขึ้นเพื่อความสวยงาม
      ...
      <div className="mt-10 rounded-[10px] border-l-[3px] border-l-warn bg-warn-soft px-5 py-4">
